...
import com.examplemonevo.Interfaces.InterestBearing;
...
public class InvestmentAccount extends Account implements InterestBearing, Withdrawable {
    ...
    private static final double MIN_OPENING_BALANCE = 0;
    ...
    public InvestmentAccount(String accountNumber, double initialDeposit, String branch, Customer customer) {
        super(accountNumber, initialDeposit, branch, customer, "Investment Account" );
    ...
    public void setLastInterestApplied(LocalDate date) {
        this.lastInterestApplied = date;
    }
